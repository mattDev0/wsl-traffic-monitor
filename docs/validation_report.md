...
This report documents the experimental validation protocol for WSL Traffic Monitor on native Windows hosts. This specification serves as a test execution template to log empirical measurements when running under native Windows 10/11 environments.

---

## 1. System Metadata Template

| Parameter | Specification / Target |
|---|---|
| **OS Name & Build** | Native Windows 10 / 11 Host |
...
*   **Measurements**:
    *   Host Physical bytes delta: [Pending Windows host execution]
    *   WSL Virtual bytes delta: [Pending Windows host execution]
    *   Reported Rate by Sampler (B/s): [Pending Windows host execution]
...
*   **Measurements**:
    *   Host Physical download rate (B/s): [Pending Windows host execution]
    *   WSL virtual reported download rate (B/s): [Pending Windows host execution]
...
*   **Measurements**:
    *   Docker container bytes transferred: [Pending Windows host execution]
    *   WSL Virtual bytes delta: [Pending Windows host execution]
...
*   **Idle CPU Usage**: [Pending Windows host execution] (Target: <0.2%)
*   **Active CPU Usage**: [Pending Windows host execution]
*   **Private Working Set (Memory)**: [Pending Windows host execution] (Target: <30 MB)
